...
def copy_resources(app_android_root):
    ...
    assets_pomelo_dir = assets_dir + "/pomelo-cocos2d-jsb";
    os.mkdir(assets_res_dir);
    os.mkdir(assets_scripts_dir);
    os.mkdir(assets_jsb_dir);
    os.mkdir(assets_pomelo_dir);
    ...
    resources_dir = os.path.join(app_android_root, "../../../pomelo-cocos2d-jsb")
    copy_files(resources_dir, assets_pomelo_dir)

    resources_dir = os.path.join(app_android_root, "../../cocos2d-x/cocos/scripting/js-bindings/script")
